...
const Sale = () => {
    ...
    useEffect(() => {
        const fetchItems = async () => {
            try {
                const response = await axios.get('http://localhost:8080/category/sale');
                setItems(response.data);
                setLoading(false);
            } catch (error) {
                setError("Error fetching sale items. Please try again.");
                setLoading(false);
        ...
        <div className="container-xxl py-5">
            <div className="container">
                <div className="row g-4">
                    {loading && <p>Loading sale items...</p>}
